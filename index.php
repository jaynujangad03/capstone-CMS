...
<body class="bg-white">
  ...
  <header class="w-full bg-white shadow-sm fixed top-0 left-0 right-0 z-50">
    <div class="container mx-auto px-6 py-4 flex items-center justify-between">
      <div class="flex items-center">
        <a href="#" class="mr-12 block" style="width:64px;height:64px;">
  ...
  <section class="w-full pt-28 pb-16 md:py-32 relative overflow-hidden"
    style="background-image: url('building.webp'); background-size: cover; background-position: center;">
...
`;
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      // If there is a login error, show the modal automatically
